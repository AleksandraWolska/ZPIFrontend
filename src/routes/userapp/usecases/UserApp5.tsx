...
function UserApp5() {
    ...
    return (
        <Box padding={3}>
            <Typography variant="h6">Userapp variant 4 - jeden uzytkownik na jeden przedmiot, konkretna godzina </Typography>
            <Typography variant="body1" color="orange"> one item, one user simultaneously, specific time. </Typography>
